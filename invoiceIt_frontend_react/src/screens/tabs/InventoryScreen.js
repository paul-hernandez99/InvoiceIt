...
const InventoryScreen = () => {
    ...
    const handleFetchChartData = async () => {
        try {
            ...
            filteredPurchases.forEach(purchase => {
                ...
                if (!purchasesMap.has(purchaseDate) || purchasesMap.get(purchaseDate).price_per_unit < purchase.price_per_unit) {
                    purchasesMap.set(purchaseDate, purchase);
                }
            });
            ...
            const reversedData = filteredUniquePurchases.map(purchase => purchase.price_per_unit).reverse();
    ...
    }, [selectedProduct, timeRange, startDate, endDate]);
    ...
    const filterProductsByDateRange = () => {
        ...
        // Return only the first 30 elements
    ...
    return (
        <div className="container mt-5">
            ...
            <div className="mt-5">
                <button className="btn btn-primary" onClick={downloadProducts}>Download Products</button>
